...
def convert_num(num):
    ...
    if num >=100 and num < 1000:
        return get_nums_above_100_less_than_1000(num)

def convert_below_100_num_to_string(num):
    if num < 19:
        return get_teens_and_below(num)
    if num > 19 and num < 100:
        return get_words_below_100_above_teen(num)
...
def get_nums_above_100_less_than_1000(num):
    string_num = str(num)
    word_1 = WORDS[int(string_num[0])] + 'hundred'
    print(string_num[1])
    print(string_num[2])
    # num2_int = int(num_2)
    # word_2 = convert_below_100_num_to_string(num2_int)
    # return word_1 + word_2
